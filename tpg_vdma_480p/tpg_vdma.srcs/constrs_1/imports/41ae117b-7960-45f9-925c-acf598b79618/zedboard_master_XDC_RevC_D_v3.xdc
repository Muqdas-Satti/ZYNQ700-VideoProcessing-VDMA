...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {clk_out1_0}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {hsync_out_0}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {vsync_out_0}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {m_axis_video_TDATA_0[0]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {m_axis_video_TDATA_[1]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {m_axis_video_TDATA_0[2]}];  # "LD5"
